...
class Material():
    def __init__(self):
        ...
        self.muscosa = self.add_muscosa_staining()
    ...
    def add_nuclei_staining(self, transmission=0.5, name="tissue_staining", base_color=(0.05, 0.0, 0.3, 1.0)):
        # add new material and node tree
        material = bpy.data.materials.new(name=name)
        material.use_nodes = True
        nodes = material.node_tree.nodes
    ...
    def add_muscosa_staining(self, transmission=0.929, name="muscosa", base_color=(0.62, 0.25, 0.65, 1.0)):
        # add new material and node tree
        material = bpy.data.materials.new(name=name)
        material.use_nodes = True
        nodes = material.node_tree.nodes
