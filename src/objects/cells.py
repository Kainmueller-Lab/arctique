...
class CellAttributeB(CellAttribute):
    def __init__(self, cell_type = "B", size = 0.8, scale = (1, 0.5, 0.4), deformation_strength = 0.6, attribute_name = "Cell Type B", max_bending_strength = 0.3):
        self.cell_type = cell_type
        self.size = size
        self.scale = scale
        self.deformation_strength = deformation_strength
...
class CellAttributeEpi(CellAttribute):
    ...
    def __init__(self, cell_type = "Epi", size = 0.04, scale = (1, 0.8, 0.7), deformation_strength = 0.2, attribute_name = "Epithelial cell", max_bending_strength = 0.3):
        self.cell_type = cell_type
        self.size = size
        self.scale = scale
        self.deformation_strength = deformation_strength
